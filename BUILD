...
filegroup(
    ...
    srcs = [
        ...
        "//kubernetes/docs:all-srcs",
        "//kubernetes/examples:all-srcs",
        "//kubernetes/hack:all-srcs",
        "//kubernetes/test/e2e/testing-manifests:all-srcs",
        "//kubernetes/test/images:all-srcs",
        "//kubernetes/test/kubemark:all-srcs",
        "//kubernetes/third_party/htpasswd:all-srcs",
        "//kubetest:all-srcs",
        "//label_sync:all-srcs",
