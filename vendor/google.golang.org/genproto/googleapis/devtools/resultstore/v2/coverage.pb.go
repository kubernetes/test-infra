...
func (*LineCoverage) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_cf37bf4336d4edc8, []int{0}
}
...
func (*BranchCoverage) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_cf37bf4336d4edc8, []int{1}
}
...
func (*FileCoverage) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_cf37bf4336d4edc8, []int{2}
}
...
func (*ActionCoverage) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_cf37bf4336d4edc8, []int{3}
}
...
func init() {
	proto.RegisterFile("google/devtools/resultstore/v2/coverage.proto", fileDescriptor_coverage_cf37bf4336d4edc8)
}

var fileDescriptor_coverage_cf37bf4336d4edc8 = []byte{
