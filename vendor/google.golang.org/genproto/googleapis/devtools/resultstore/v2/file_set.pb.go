...
func (*FileSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_set_ffa23055473f4928, []int{0}
}
...
func (*FileSet_Id) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_set_ffa23055473f4928, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("google/devtools/resultstore/v2/file_set.proto", fileDescriptor_file_set_ffa23055473f4928)
}

var fileDescriptor_file_set_ffa23055473f4928 = []byte{
