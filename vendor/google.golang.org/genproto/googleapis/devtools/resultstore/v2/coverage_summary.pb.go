...
func (*LineCoverageSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_summary_6ce81cdd85c870eb, []int{0}
}
...
func (*BranchCoverageSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_summary_6ce81cdd85c870eb, []int{1}
}
...
func (*LanguageCoverageSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_coverage_summary_6ce81cdd85c870eb, []int{2}
}
...
func init() {
	proto.RegisterFile("google/devtools/resultstore/v2/coverage_summary.proto", fileDescriptor_coverage_summary_6ce81cdd85c870eb)
}

var fileDescriptor_coverage_summary_6ce81cdd85c870eb = []byte{
