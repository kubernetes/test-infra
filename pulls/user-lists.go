...
func (sq *SubmitQueue) RefreshWhitelist(config *github_util.Config) sets.String {
	...
	allUsers = allUsers.Union(*sq.additionalUserWhitelist)
...
func (sq *SubmitQueue) doGenCommitters(config *github_util.Config) error {
	...
	if err = writeWhitelist(sq.Committers, "# auto-generated by "+os.Args[0]+" gen-committers; manual additions should go in the whitelist", pushUsers); err != nil {
