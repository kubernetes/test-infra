...
dind_image="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220908-70b61d242b-master"
...
resources_for_kubernetes () {
    ...
    echo "${indentation}resources:"
    echo "${indentation} requests:"
...
EOF
                            ;;
    esac | while read -r line; do echo "${indentation}  ${line}"; done
}
