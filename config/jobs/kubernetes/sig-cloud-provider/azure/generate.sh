...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220921-e07b053bd5-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220921-e07b053bd5-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
