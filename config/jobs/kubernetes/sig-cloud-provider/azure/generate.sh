...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220427-c2db0f69b7-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220427-c2db0f69b7-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
