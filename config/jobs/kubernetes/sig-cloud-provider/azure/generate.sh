...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220623-1a63fdd9f2-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220623-1a63fdd9f2-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
