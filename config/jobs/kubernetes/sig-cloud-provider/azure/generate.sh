...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220420-a8dc19ed91-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220420-a8dc19ed91-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
