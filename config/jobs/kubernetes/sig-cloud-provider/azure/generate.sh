...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20231116-481eaca3cb-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20231116-481eaca3cb-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
