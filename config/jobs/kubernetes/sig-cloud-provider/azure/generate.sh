...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220916-c3af09ab20-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220916-c3af09ab20-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
