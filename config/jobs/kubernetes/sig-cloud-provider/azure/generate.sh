...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230123-d369720788-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230123-d369720788-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
