...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260727-e41b93b47b-master"
...
$(generate_serviceaccount_name 4 ${capz_release})
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260727-e41b93b47b-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
