...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220812-2d111f2c30-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220812-2d111f2c30-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
