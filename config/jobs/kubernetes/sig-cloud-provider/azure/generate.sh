...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260824-a5e45c393a-master"
...
$(generate_serviceaccount_name 4 ${capz_release})
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260824-a5e45c393a-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
