...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230125-972f786877-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230125-972f786877-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
