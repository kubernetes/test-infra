...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230116-866ee24d6f-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230116-866ee24d6f-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
