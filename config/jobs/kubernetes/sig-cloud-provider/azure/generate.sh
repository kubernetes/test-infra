...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220720-b949db7485-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220720-b949db7485-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
