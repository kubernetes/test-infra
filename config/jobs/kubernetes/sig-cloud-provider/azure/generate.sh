...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220729-444b10105a-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220729-444b10105a-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
