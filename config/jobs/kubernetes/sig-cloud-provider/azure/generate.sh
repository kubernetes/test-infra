...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260807-e16bbc2ef7-master"
...
$(generate_serviceaccount_name 4 ${capz_release})
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260807-e16bbc2ef7-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
