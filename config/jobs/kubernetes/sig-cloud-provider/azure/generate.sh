...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20221020-c1f65f2ba7-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20221020-c1f65f2ba7-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
