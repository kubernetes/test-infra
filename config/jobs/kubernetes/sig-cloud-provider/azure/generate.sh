...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20240209-9f1c807c55-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20240209-9f1c807c55-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
