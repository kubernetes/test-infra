...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20240513-a9bd71bf01-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20240513-a9bd71bf01-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
