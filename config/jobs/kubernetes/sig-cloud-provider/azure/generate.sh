...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260817-81577dc432-master"
...
$(generate_serviceaccount_name 4 ${capz_release})
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260817-81577dc432-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
