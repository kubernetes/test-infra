...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20221021-f25568465b-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20221021-f25568465b-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
