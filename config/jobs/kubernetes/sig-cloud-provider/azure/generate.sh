...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230124-61b36115b7-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20230124-61b36115b7-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
