...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260615-b4199512ce-master"
...
$(generate_serviceaccount_name 4 ${capz_release})
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20260615-b4199512ce-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
