...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20221020-96ba49123f-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20221020-96ba49123f-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
