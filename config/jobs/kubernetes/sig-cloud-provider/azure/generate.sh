...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20240701-63170bb1ec-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20240701-63170bb1ec-master
      command:
      - runner.sh
      - ./scripts/ci-entrypoint.sh
      args:
