...
tmp="gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220916-2cde602c65-master"
...
- interval: 24h
  ...
  spec:
    containers:
    - image: gcr.io/k8s-staging-test-infra/kubekins-e2e:v20220916-2cde602c65-master
      command:
      - runner.sh
      - ./scripts/ci-conformance.sh
      env:
