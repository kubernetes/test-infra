...
import boto3  # pylint: disable=import-error,unused-import
...
def build_cron(key, runs_per_day):
    ...
    if runs_per_day > 0:
        ...
        return "%d %d-23/%d * * *" % (minute, hour_offset, hour_denominator), (
            runs_per_day * 7
        )
...
def k8s_version_info(k8s_version):
    ...
    if k8s_version == "latest":
        ...
        raise Exception("missing required k8s_version") # pylint: disable=broad-except
