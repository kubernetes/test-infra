...
def build_test(cloud='aws',
    ...
    if k8s_version == 'latest':
        ...
        e2e_image = "gcr.io/k8s-testimages/kubekins-e2e:v20210201-cc9840e-master"
        ...
        e2e_image = "gcr.io/k8s-testimages/kubekins-e2e:v20210201-cc9840e-1.18"
...
def generate():
    print("# Test scenarios generated by build_grid.py (do not manually edit)")
    print("periodics:")
