...
def build_tests(branch, k8s_version):
    ...
    if branch == 'master':
        ...
        # TODO(rifelpet): Update this from master to 1.20 once the image variant has been pushed
        ...
        e2e_image = "gcr.io/k8s-testimages/kubekins-e2e:v20201021-a62ce8a-1.19"
...
def generate():
    ...
    for branch in branches:
        k8s_version = "1.20" if branch == "master" else branch
