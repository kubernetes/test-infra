...
gce_distro_images = {
    ...
    "u2204arm64": latest_gce_image("ubuntu-os-cloud", "ubuntu-2204-lts-arm64", "ARM64"),
...
aws_distro_images = {
    ...
    'al2027arm64': latest_aws_image('137112412989', 'al2027-preview-ami-2*-kernel-7.1-arm64', 'arm64'), # pylint: disable=line-too-long
