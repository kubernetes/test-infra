...
IMAGE = "us-central1-docker.pkg.dev/k8s-staging-test-infra/images/kubekins-e2e:v20260729-f0c41ad0b9-master"  # pylint: disable=line-too-long
...
def build_pinned_periodic(script_name, ref):
    ...
    job["annotations"]["description"] = (
        f"Pinned to {ref}; this script no longer exists on main."
    )
    return job
