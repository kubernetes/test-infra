...
| <a id="lifecycle/ready" href="#lifecycle/ready">`lifecycle/ready`</a> | Indicates that an issue or PR is triaged and ready to be worked by a contributor.| anyone |  [lifecycle](https://git.k8s.io/test-infra/prow/plugins/lifecycle) |
...
| <a id="needs-triage" href="#needs-triage">`needs-triage`</a> | Indicates an issue needs to be triaged and lacks a `lifecycle/foo` label.| prow |  [require-matching-label](https://git.k8s.io/test-infra/prow/plugins/require-matching-label) |
