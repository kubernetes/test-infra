...
| <a id="kind/test" href="#kind/test">`kind/test`</a> | Categorizes issue or PR as related to the reinforcement of tests, or the addition of new tests.| anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
