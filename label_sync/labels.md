...
| <a id="closed/cannot-repro" href="#closed/cannot-repro">`closed/cannot-repro`</a> | Indicates an issue has been closed due to an inability to reproduce it. <br><br> This was previously `triage/not-reproducible`, `close/not-reproducible`, | humans | |
| <a id="closed/duplicate" href="#closed/duplicate">`closed/duplicate`</a> | Indicates an issue is a duplicate of other open issue. <br><br> This was previously `triage/duplicate`, `duplicate`, | humans | |
| <a id="closed/support" href="#closed/support">`closed/support`</a> | Indicates an issue has been closed because it's a support question. <br><br> This was previously `triage/support`, `close/support`, `kind/support`, `question`, | humans | |
| <a id="closed/wontfix" href="#closed/wontfix">`closed/wontfix`</a> | Indicates an issue that can not or will not be resolved. <br><br> This was previously `triage/unresolved`, `close/unresolved`, `invalid`, `wontfix`, | humans | |
...
| <a id="needs-info" href="#needs-info">`needs-info`</a> | Indicates an issue needs more information in order to work on it. <br><br> This was previously `close/needs-information`, `triage/needs-information`, | humans | |
...
| <a id="sig/onprem" href="#sig/onprem">`sig/onprem`</a> | REMOVING. This will be deleted after 2019-12-17 00:00:00 +0000 +0000 <br><br> Categorizes an issue or PR as relevant to sig-onprem.| anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
