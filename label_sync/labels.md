...
| <a id="wg/app-def" href="#wg/app-def">`wg/app-def`</a> | REMOVING. This will be deleted after 2019-02-09 13:00:00 +0000 UTC <br><br> Categorizes an issue or PR as relevant to wg-app-def.| anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
...
| <a id="wg/container-identity" href="#wg/container-identity">`wg/container-identity`</a> | REMOVING. This will be deleted after 2019-02-09 13:00:00 +0000 UTC <br><br> Categorizes an issue or PR as relevant to wg-container-identity.| anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
