...
| <a id="kind/support" href="#kind/support">`kind/support`</a> | Indicates an issue that is a support question. <br><br> This was previously `close/support`, `question`, `triage/support`, | humans | |
| <a id="lifecycle/needs-info" href="#lifecycle/needs-info">`lifecycle/needs-info`</a> | Indicates an issue needs more information in order to work on it. <br><br> This was previously `close/needs-information`, `triage/needs-information`, | humans |  [lifecycle](https://git.k8s.io/test-infra/prow/plugins/lifecycle) |
| <a id="needs-triage" href="#needs-triage">`needs-triage`</a> | Indicates an issue needs to be triaged and accepted by a SIG or subproject.| prow |  [require-matching-label](https://git.k8s.io/test-infra/prow/plugins/require-matching-label) |
...
| <a id="triage/accepted" href="#triage/accepted">`triage/accepted`</a> | Indicates that an issue has been triaged by a SIG or subproject and is ready to be worked on.| anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
| <a id="triage/duplicate" href="#triage/duplicate">`triage/duplicate`</a> | REMOVING. This will be deleted after 2020-04-20 00:00:00 +0000 UTC <br><br> Indicates an issue is a duplicate of other open issue. <br><br> This was previously `close/duplicate`, `duplicate`, | humans | |
| <a id="triage/not-reproducible" href="#triage/not-reproducible">`triage/not-reproducible`</a> | REMOVING. This will be deleted after 2020-04-20 00:00:00 +0000 UTC <br><br> Indicates an issue can not be reproduced as described. <br><br> This was previously `close/not-reproducible`, | humans | |
| <a id="triage/unresolved" href="#triage/unresolved">`triage/unresolved`</a> | REMOVING. This will be deleted after 2020-04-20 00:00:00 +0000 UTC <br><br> Indicates an issue that can not or will not be resolved. <br><br> This was previously `close/unresolved`, `invalid`, `wontfix`, | humans | |
