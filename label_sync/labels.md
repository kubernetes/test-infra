...
| <a id="closed/duplicate" href="#closed/duplicate">`closed/duplicate`</a> | Indicates an issue is a duplicate of other open issue. <br><br> This was previously `triage/duplicate`, `close/duplicate`, `duplicate`, | humans | |
| <a id="needs-info" href="#needs-info">`needs-info`</a> | Indicates an issue needs more information in order to work on it. <br><br> This was previously `triage/needs-information`, `close/needs-information`, | humans | |
