...
# the local checkout of k8s.io/kubernetes to avoid multiple checkout.This not
...
"${SCRIPT_DIR}"/publish_template.sh "sample-apiserver" "${1}" "${2}" "apiserver,apimachinery,client-go" "${3}"
