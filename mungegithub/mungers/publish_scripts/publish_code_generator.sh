...
# k8s.io/kubernetes/staging/src/code-generator to the ${dst_branch} of
# k8s.io/code-generator.
#
# ${kubernetes_remote} is the remote url of k8s.io/kubernetes that will be used
# in .git/config in the local checkout of code-generator. We usually set it to the
...
"${SCRIPT_DIR}"/publish_template.sh "code-generator" "${1}" "${2}" "${3}" "${4}" "true"
