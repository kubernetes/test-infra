	...
	tests := []struct {
	...
	}{
		{
			...
			issue: &githubapi.Issue{
				...
				Labels:           []githubapi.Label{githubapi.Label{Name: githubapi.String(helpWanted)}},
				PullRequestLinks: &githubapi.PullRequestLinks{},
				Assignee:         &githubapi.User{Login: githubapi.String(username)},
				Number:           intPtr(1),
			},
			expected: []githubapi.Label{githubapi.Label{Name: githubapi.String(helpWanted)}},
		},
		{
			name:     "issue is null",
			issue:    nil,
		...
		},
		{
			...
			issue: &githubapi.Issue{
				State: githubapi.String(open),
				Labels: []githubapi.Label{githubapi.Label{Name: githubapi.String(helpWanted)},
					githubapi.Label{Name: githubapi.String(sigApps)}},
				PullRequestLinks: nil,
				Assignee:         &githubapi.User{Login: githubapi.String(username)},
				Number:           intPtr(1),
			},
		...
		},
		{
			...
			expected: []githubapi.Label{githubapi.Label{Name: githubapi.String(helpWanted)},
				githubapi.Label{Name: githubapi.String(needsSigLabel)}},
		},
		{
