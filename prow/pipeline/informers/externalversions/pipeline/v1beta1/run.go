	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TektonV1beta1().Runs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TektonV1beta1().Runs(namespace).Watch(context.TODO(), options)
			},
		},
		&pipelinev1beta1.Run{},
		resyncPeriod,
...
func (f *runInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pipelinev1beta1.Run{}, f.defaultInformer)
}

func (f *runInformer) Lister() v1beta1.RunLister {
	return v1beta1.NewRunLister(f.Informer().GetIndexer())
}
