...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("conditions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Tekton().V1beta1().Conditions().Informer()}, nil
	...
	case v1beta1.SchemeGroupVersion.WithResource("runs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Tekton().V1beta1().Runs().Informer()}, nil
