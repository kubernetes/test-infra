...
type RunLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Run, err error)
...
// List lists all Runs in the indexer.
func (s *runLister) List(selector labels.Selector) (ret []*v1beta1.Run, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Run))
	})
	return ret, err
}
...
type RunNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.Run, error)
...
// List lists all Runs in the indexer for a given namespace.
func (s runNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Run, err error) {
...
// Get retrieves the Run from the indexer for a given namespace and name.
func (s runNamespaceLister) Get(name string) (*v1beta1.Run, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("run"), name)
	}
	return obj.(*v1beta1.Run), nil
}
