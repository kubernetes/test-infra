...
func TestAddLifecycleLabels(t *testing.T) {
	var testcases = []struct {
		...
		},
		{
			...
			added:   []string{labels.LifecycleFrozenLabel},
			removed: []string{},
			labels:  []string{},
		},
		{
			...
			added:   []string{labels.LifecycleStaleLabel},
			removed: []string{},
			labels:  []string{},
		},
		{
			...
			added:   []string{labels.LifecycleRottenLabel},
			removed: []string{},
			labels:  []string{},
		},
		{
			...
			added:   []string{},
			removed: []string{labels.LifecycleFrozenLabel},
			labels:  []string{labels.LifecycleFrozenLabel},
		},
		{
			name:    "remove stale, have it -> stale removed",
			body:    "/remove-lifecycle stale",
			added:   []string{},
			removed: []string{labels.LifecycleStaleLabel},
			labels:  []string{labels.LifecycleStaleLabel},
		},
		{
			name:    "remove rotten, have it -> rotten removed",
			body:    "/remove-lifecycle rotten",
			added:   []string{},
			removed: []string{labels.LifecycleRottenLabel},
			labels:  []string{labels.LifecycleRottenLabel},
		},
		{
		...
		},
		{
			...
			body:    "/lifecycle stale",
			added:   []string{labels.LifecycleStaleLabel},
			removed: []string{labels.LifecycleActiveLabel},
			labels:  []string{labels.LifecycleActiveLabel},
		},
		{
		...
		},
		{
			...
			body:    "/lifecycle frozen",
			added:   []string{labels.LifecycleFrozenLabel},
			removed: []string{labels.LifecycleStaleLabel, labels.LifecycleRottenLabel},
			labels:  []string{labels.LifecycleStaleLabel, labels.LifecycleRottenLabel},
		},
		{
