...
<!-- META={"approvers":[]} -->`,
		},
		{
			...
			files:               []string{"c/c.go"},
			comments:            []github.IssueComment{},
			reviews:             []github.Review{newTestReview("cjwagner", "stuff", "APPROVED")},
			selfApprove:         false,
			needsIssue:          false,
			lgtmActsAsApprove:   false,
			reviewActsAsApprove: false,
...
<!-- META={"approvers":["cjwagner"]} -->`,
		},
		{
			...
			files:               []string{"a/a.go"},
			comments:            []github.IssueComment{},
			reviews:             []github.Review{newTestReview("Alice", "stuff", "APPROVED")},
			selfApprove:         false,
			needsIssue:          false,
			lgtmActsAsApprove:   false,
...
<!-- META={"approvers":["cjwagner"]} -->`,
		},
		{
			...
			reviews: []github.Review{
				newTestReview("cjwagner", "yep", "APPROVED"),
				newTestReview("cjwagner", "nope", "CHANGES_REQUESTED"),
			},
			selfApprove:         false,
			needsIssue:          false,
			lgtmActsAsApprove:   false,
