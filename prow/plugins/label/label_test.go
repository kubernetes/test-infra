...
func TestLabel(t *testing.T) {
	...
	testcases := []testCase{
		...
		},
		{
			...
			body:                  "/kind bug",
			repoLabels:            []string{"area/infra", "priority/critical", labels.BugLabel},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels(labels.BugLabel),
			expectedRemovedLabels: []string{},
			commenter:             orgMember,
		},
		{
		...
		},
		{
			...
			body:                  "  /area infra",
			repoLabels:            []string{"area/infra", "area/api", "priority/critical", "priority/urgent", "priority/important", labels.BugLabel},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels(),
			expectedRemovedLabels: []string{},
			commenter:             orgMember,
