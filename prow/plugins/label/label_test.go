...
func TestLabel(t *testing.T) {
	...
	var testcases = []struct {
		...
		},
		{
			...
			body:                  "/remove-do-not-merge",
			repoLabels:            []string{"do-not-merge"},
			issueLabels:           []string{"do-not-merge"},
			expectedNewLabels:     []string{},
			expectedRemovedLabels: formatLabels("do-not-merge"),
			commenter:             orgMember,
		},
		{
		...
		{
			name:                  "Remove do-not-merge Label and some other Lable",
			body:                  "/remove-do-not-merge\n/remove-kind api",
			repoLabels:            []string{"kind/api", "do-not-merge"},
			issueLabels:           []string{"kind/api", "do-not-merge"},
			expectedNewLabels:     []string{},
			expectedRemovedLabels: formatLabels("do-not-merge", "kind/api"),
			commenter:             orgMember,
		},
		{
			name:                  "Multiple Add and Delete Labels",
			body:                  "/remove-do-not-merge\n/remove-area ruby\n/remove-kind srv\n/remove-priority l m\n/area go\n/kind cli\n/priority h",
			repoLabels:            []string{"do-not-merge", "area/go", "area/ruby", "kind/cli", "kind/srv", "priority/h", "priority/m", "priority/l"},
			issueLabels:           []string{"do-not-merge", "area/ruby", "kind/srv", "priority/l", "priority/m"},
			expectedNewLabels:     formatLabels("area/go", "kind/cli", "priority/h"),
			expectedRemovedLabels: formatLabels("do-not-merge", "area/ruby", "kind/srv", "priority/l", "priority/m"),
			commenter:             orgMember,
		},
	}
