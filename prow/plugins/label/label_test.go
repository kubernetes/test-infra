...
func TestLabel(t *testing.T) {
	...
	testcases := []testCase{
		...
		},
		{
			...
			repoLabels:            []string{approvedForMilestoneLabel},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels(approvedForMilestoneLabel),
			expectedRemovedLabels: []string{},
			commenter:             "sig-lead",
		},
		{
			name:                  "Non sig lead can't add status/approved-for-milestone",
			body:                  "/status approved-for-milestone",
			repoLabels:            []string{approvedForMilestoneLabel},
			issueLabels:           []string{},
		...
		{
			name:                  "Remove Status Approved Label",
			body:                  "/remove-status approved-for-milestone ",
			repoLabels:            []string{approvedForMilestoneLabel},
			issueLabels:           []string{approvedForMilestoneLabel},
			expectedNewLabels:     []string{},
			expectedRemovedLabels: formatLabels(approvedForMilestoneLabel),
			commenter:             "sig-lead",
		},
		{
			name:                  "Non sig lead can't remove status/approved-for-milestone",
			body:                  "/remove-status approved-for-milestone",
			repoLabels:            []string{approvedForMilestoneLabel},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels(),
		...
		},
		{
			...
			repoLabels:            []string{approvedForMilestoneLabel, inProgressLabel},
			issueLabels:           []string{approvedForMilestoneLabel},
			expectedNewLabels:     formatLabels(inProgressLabel),
			expectedRemovedLabels: []string{},
			commenter:             "random-user",
		},
		{
			name:                  "Add Status In Progress Label Without Status Approved Label",
			body:                  "/status in-progress",
			repoLabels:            []string{approvedForMilestoneLabel, inProgressLabel},
			issueLabels:           []string{},
			expectedNewLabels:     []string{},
		...
		{
			name:                  "Sig Lead Adds Status In Progress Label And Status Approved Label",
			body:                  "/status approved-for-milestone in-progress",
			repoLabels:            []string{approvedForMilestoneLabel, inProgressLabel},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels(approvedForMilestoneLabel, inProgressLabel),
			expectedRemovedLabels: []string{},
			commenter:             "sig-lead",
		},
		{
			name:                  "Non-Sig Lead Adds Status In Progress Label And Status Approved Label",
			body:                  "/status approved-for-milestone in-progress",
			repoLabels:            []string{approvedForMilestoneLabel, inProgressLabel},
			issueLabels:           []string{},
			expectedNewLabels:     []string{},
