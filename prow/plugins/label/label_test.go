...
func TestLabel(t *testing.T) {
	...
	testcases := []testCase{
		...
		{
			name:                  "Infer Sig and Kind Labels From Mention",
			body:                  "@kubernetes/sig-api-machinery-proposals\n",
			repoLabels:            []string{"kind/design", "sig/api-machinery"},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels("kind/design", "sig/api-machinery"),
			expectedRemovedLabels: []string{},
			commenter:             orgMember,
		},
		{
			name:                  "Add SIG Label and Infer Sig and Kind Labels From Mention",
			body:                  "/sig testing\ncc @kubernetes/sig-api-machinery-feature-requests\n",
			repoLabels:            []string{"kind/feature", "sig/testing", "sig/api-machinery"},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels("sig/testing", "sig/api-machinery", "kind/feature"),
			expectedRemovedLabels: []string{},
			commenter:             orgMember,
		},
		{
			name:                  "Infer Sig Label and Kind",
			body:                  "@kubernetes/sig-api-machinery-bugs\n",
			repoLabels:            []string{"kind/bug", "sig/api-machinery"},
			issueLabels:           []string{},
			expectedNewLabels:     formatLabels("kind/bug", "sig/api-machinery"),
			expectedRemovedLabels: []string{},
			commenter:             orgMember,
		},
		{
