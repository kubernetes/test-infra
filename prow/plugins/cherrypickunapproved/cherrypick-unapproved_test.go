...
func TestCherryPickUnapprovedLabel(t *testing.T) {
	var testcases = []struct {
		...
		},
		{
			...
			branch:        "release-1.10",
			action:        github.PullRequestActionOpened,
			labels:        []string{labels.CpUnapprovedLabel},
			added:         []string{},
			removed:       []string{},
			expectComment: false,
		},
		{
			...
			branch:        "release-1.10",
			action:        github.PullRequestActionOpened,
			labels:        []string{labels.CpApprovedLabel, labels.CpUnapprovedLabel},
			added:         []string{},
			removed:       []string{labels.CpUnapprovedLabel},
			expectComment: false,
		},
		{
			...
			action:        github.PullRequestActionOpened,
			labels:        []string{},
			added:         []string{labels.CpUnapprovedLabel},
			removed:       []string{},
			expectComment: true,
		},
		{
