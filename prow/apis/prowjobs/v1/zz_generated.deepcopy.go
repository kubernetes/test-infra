...
func (in *ProwJobSpec) DeepCopyInto(out *ProwJobSpec) {
	*out = *in
	...
	if in.RerunPermissions != nil {
		in, out := &in.RerunPermissions, &out.RerunPermissions
		*out = new(RerunPermissions)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RerunPermissions) DeepCopyInto(out *RerunPermissions) {
	*out = *in
	if in.GitHubTeams != nil {
		in, out := &in.GitHubTeams, &out.GitHubTeams
		*out = make([]int, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RerunPermissions.
func (in *RerunPermissions) DeepCopy() *RerunPermissions {
	if in == nil {
		return nil
	}
	out := new(RerunPermissions)
