...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in Caches) DeepCopyInto(out *Caches) {
	{
		in := &in
		*out = make(Caches, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(Cache)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Caches.
func (in Caches) DeepCopy() Caches {
	if in == nil {
		return nil
	}
	out := new(Caches)
