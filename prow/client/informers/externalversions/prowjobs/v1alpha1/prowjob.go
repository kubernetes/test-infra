...
import (
	...
	prowjobsv1alpha1 "k8s.io/test-infra/prow/apis/prowjobs/v1alpha1"
	...
	v1alpha1 "k8s.io/test-infra/prow/client/listers/prowjobs/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProwV1alpha1().ProwJobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProwV1alpha1().ProwJobs(namespace).Watch(options)
			},
		},
		&prowjobsv1alpha1.ProwJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *prowJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&prowjobsv1alpha1.ProwJob{}, f.defaultInformer)
}

func (f *prowJobInformer) Lister() v1alpha1.ProwJobLister {
	return v1alpha1.NewProwJobLister(f.Informer().GetIndexer())
}
