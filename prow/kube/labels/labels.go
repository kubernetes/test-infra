...
// This is a copy of https://github.com/kubernetes/apimachinery/blob/18a564baac720819100827c16fdebcadb05b2d0d/pkg/labels/labels.go
//
// Equals is renamed to Equal.
...
// Equal returns true if the given maps are equal
