...
// that control the throttler behavior
...
// DenyThrottlerOptions suppresses the presence of throttler-related flags,
...
func DenyThrottlerOptions() FlagParameter {
	return func(o *flagParams) {
		o.denyThrottlerOptions = true
	}
}
...
func (o *GitHubOptions) addFlags(fs *flag.FlagSet, paramFuncs ...FlagParameter) {
	...
	if !params.denyThrottlerOptions {
