...
func (o *KubernetesOptions) Client(namespace string, dryRun bool) (client *kube.Client, clientset kubernetes.Interface, err error) {
	if dryRun {
		return kube.NewFakeClient(o.deckURI), nil, nil
	}
	...
	return legacyClient, defaultClient, err
}
