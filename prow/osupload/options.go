...
func (o *Options) Validate() error {
	...
	if !o.DryRun {
		if o.Bucket == "" {
			return errors.New("Object Storage upload was requested no Object Storage bucket was provided")
		}

		if o.GcsCredentialsFile == "" {
			return errors.New("Object Storage upload was requested but no Object Storage credentials file was provided")
		}
	}
...
// the Object Storage upload options struct given.
func (o *Options) AddFlags(fs *flag.FlagSet) {
	fs.StringVar(&o.SubDir, "sub-dir", "", "Optional sub-directory of the job's path to which artifacts are uploaded")

	fs.StringVar(&o.PathStrategy, "path-strategy", prowapi.PathStrategyExplicit, "how to encode org and repo into Object Storage paths")
	fs.StringVar(&o.DefaultOrg, "default-org", "", "optional default org for Object Storage path encoding")
	fs.StringVar(&o.DefaultRepo, "default-repo", "", "optional default repo for Object Storage path encoding")

	fs.Var(&o.gcsPath, "gcs-path", "Object Storage path to upload into")
	fs.StringVar(&o.GcsCredentialsFile, "gcs-credentials-file", "", "file where Google Cloud authentication credentials are stored")
	fs.BoolVar(&o.DryRun, "dry-run", true, "do not interact with Object Storage")
