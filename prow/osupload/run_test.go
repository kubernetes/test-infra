...
func TestOptions_AssembleTargets(t *testing.T) {
	var testCases = []struct {
		...
		options  Options
		paths    []string
		extra    map[string]objectstorage.UploadFunc
		expected []string
	}{
		{
		...
		},
		{
			...
			extra: map[string]objectstorage.UploadFunc{
				"something": objectstorage.DataUpload(strings.NewReader("data")),
				"else":      objectstorage.DataUpload(strings.NewReader("data")),
			},
			expected: []string{
