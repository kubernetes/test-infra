...
func (o *options) validate() error {
	if o.gerritWorkers+o.pubsubWorkers+o.githubWorkers+o.slackWorkers+o.blobStorageWorkers+o.k8sBlobStorageWorkers++o.dingTalkWorkers+o.resultStoreWorkers <= 0 {
