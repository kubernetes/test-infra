...
func createSecret(client ClientInterface, ctx context.Context, o options) (string, string, string, error) {
	if err := client.CreateSecret(ctx, o.secretID); err != nil {
		return "", "", "", fmt.Errorf("unable to create secret %v", err)
	}

	serverCertPerm, serverPrivKey, caPem, err := updateSecret(client, ctx, o)
	if err != nil {
...
func updateSecret(client ClientInterface, ctx context.Context, o options) (string, string, string, error) {
	serverCertPerm, serverPrivKey, caPem, secretData, err := genSecretData(o.expiryInYears, o.dnsNames.Strings())
	if err != nil {
		return "", "", "", err
	}

	if err := client.AddSecretVersion(ctx, o.secretID, secretData); err != nil {
