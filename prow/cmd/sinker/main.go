...
func gatherOptions() options {
	...
	flag.StringVar(&o.buildClusterKubeconfig, "build-cluster-kubeconfig", "", "Path to kubeconfig with build cluster credentials. If empty, defaults to in-cluster config.")
	flag.Parse()
	return o
}
func main() {
