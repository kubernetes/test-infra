...
type ProwClient interface {
	...
	BulkJobStatusChange(ctx context.Context, in *BulkJobStatusChangeRequest, opts ...grpc.CallOption) (*JobExecutions, error)
}
...
func (c *prowClient) BulkJobStatusChange(ctx context.Context, in *BulkJobStatusChangeRequest, opts ...grpc.CallOption) (*JobExecutions, error) {
	out := new(JobExecutions)
...
type ProwServer interface {
	...
	BulkJobStatusChange(context.Context, *BulkJobStatusChangeRequest) (*JobExecutions, error)
...
func (UnimplementedProwServer) BulkJobStatusChange(context.Context, *BulkJobStatusChangeRequest) (*JobExecutions, error) {
