...
export GINKGO_TEST_ARGS="--ginkgo.skip=\[Slow\]|\[Serial\]|\[Disruptive\]|\[Flaky\]|\[Feature:.+\] --kube-api-content-type=application/vnd.kubernetes.protobuf"
export GINKGO_PARALLEL="y"
export PROJECT="k8s-jkns-cri-gce-protobuf"
