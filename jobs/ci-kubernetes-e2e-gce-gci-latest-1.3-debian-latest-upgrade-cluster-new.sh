...
### job-env
readonly version_old="latest-1.3"
readonly version_new="latest"
readonly version_infix="g1-3-clat"
readonly image_old="gci"
readonly image_new="debian"

export E2E_OPT="--check_version_skew=false"
export E2E_UPGRADE_TEST="true"
export GINKGO_UPGRADE_TEST_ARGS="--ginkgo.focus=\[Feature:ClusterUpgrade\] --upgrade-target=ci/${version_new} --upgrade-image=${image_new}"
export JENKINS_PUBLISHED_SKEW_VERSION="ci/${version_new}"
export JENKINS_PUBLISHED_VERSION="ci/${version_old}"
export JENKINS_USE_SKEW_TESTS="true"
export KUBE_NODE_OS_DISTRIBUTION="${image_old}"
export PROJECT="gce-up-${version_infix}-up-clu-n"
