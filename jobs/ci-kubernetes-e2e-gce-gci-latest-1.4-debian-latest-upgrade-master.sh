...
### job-env
readonly version_old="latest-1.4"
readonly version_new="latest"
readonly version_infix="g1-4-clat"
readonly image_old="gci"
readonly image_new="debian"

export E2E_OPT="--check_version_skew=false"
export E2E_UPGRADE_TEST="true"
export GINKGO_UPGRADE_TEST_ARGS="--ginkgo.focus=\[Feature:MasterUpgrade\] --upgrade-target=ci/${version_new} --upgrade-image=${image_new}"
...
export PROJECT="gce-up-${version_infix}-up-mas"
