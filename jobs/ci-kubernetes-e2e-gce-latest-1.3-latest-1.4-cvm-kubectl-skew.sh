...
### job-env
readonly version_cluster="latest-1.3"
readonly version_client="latest-1.4"
readonly version_infix="1-3-1-4"


export E2E_OPT="--check_version_skew=false"
export GINKGO_PARALLEL="y"
export GINKGO_TEST_ARGS="--ginkgo.focus=Kubectl"
export JENKINS_PUBLISHED_SKEW_VERSION="ci/${version_client}"
export JENKINS_PUBLISHED_VERSION="ci/${version_cluster}"
export PROJECT="gce-cvm-upg-${version_infix}-ctl-skew"
