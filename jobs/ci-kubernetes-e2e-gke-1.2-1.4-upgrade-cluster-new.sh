...
### job-env
readonly version_old="1.2"
readonly version_new="1.4"
readonly version_infix="1-2-1-4"

export E2E_OPT="--check_version_skew=false"
export E2E_UPGRADE_TEST="true"
export GINKGO_UPGRADE_TEST_ARGS="--ginkgo.focus=\[Feature:ClusterUpgrade\] --upgrade-target=ci/latest-${version_new}"
...
export PROJECT="kube-gke-upg-${version_infix}-upg-clu-n"
