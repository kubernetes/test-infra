...
export GINKGO_UPGRADE_TEST_ARGS="--ginkgo.focus=\[Feature:MasterUpgrade\] --upgrade-target=ci/latest-${version_new}"
...
export PROJECT="kube-gke-upg-${version_infix}-upg-mas"
