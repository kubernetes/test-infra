...
### job-env
export JENKINS_GCI_HEAD_IMAGE_FAMILY="gci-56"
export GINKGO_TEST_ARGS="--ginkgo.focus=\[Serial\]|\[Disruptive\] --ginkgo.skip=\[Flaky\]|\[Feature:.+\]"
export PROJECT="e2e-gce-gci-qa-serial-m56"
