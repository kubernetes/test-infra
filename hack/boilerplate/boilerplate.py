...
skipped_dirs = ['Godeps', 'third_party', '_gopath', '_output', '.git',
                "vendor", "hack/boilerplate/test", '__init__.py']

# list all the files contain 'DO NOT EDIT', but are not generated
skipped_ungenerated_files = ['hack/boilerplate/boilerplate.py', 'experiment/generate_tests.py']
...
def get_regexs():
    ...
    # get_dates return 2014, ... until the current year as a regex: "(2014|2015|2016|2017|2018)";
